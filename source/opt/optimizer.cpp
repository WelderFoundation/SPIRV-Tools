...
spv_result_t spvOptimizeWithOptions(const spv_const_context context,
  ...
  optimizer.SetMessageConsumer(
      [&diagnostic](spv_message_level_t level, const char* source,
  ...
  memcpy(binaryOut->code, optimizerBinaryOutput.data(),
         binaryOut->wordCount * sizeof(uint32_t));
  binaryOut->code[binaryOut->wordCount] = 0;

  *pBinary = binaryOut;
  // Simplified error code (would have to get more than a bool from the
  // optimizer).
  if (success) return SPV_SUCCESS;
